...
wsl.exe -u "%WSL_USER%" --cd "%WSL_DIR%" bash -lc "set -o pipefail; python3 main.py > >(tee %LOG_FILE%) 2>&1 & PYTHON_PID=$!; trap 'kill -TERM $PYTHON_PID 2>/dev/null' TERM INT HUP; wait $PYTHON_PID"
