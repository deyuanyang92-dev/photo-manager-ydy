...
NAMING_FIELDS: tuple[NamingField, ...] = (
    NamingField("province", "省/市", "省/市", default_component=True, default_required=True),
    NamingField("site", "地区/样地", "地区/样地", default_component=True, default_required=True),
    NamingField("station", "站位", "站位", default_component=True),
    NamingField("species_id", "物种编号", "物种编号", default_component=True, default_required=True),
