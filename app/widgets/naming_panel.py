...
class NamingPanel(QWidget):
    ...
    def _setup_ui(self) -> None:
        ...
        # §7 旧: 标题 + 保存/添加/更新/删除 4 个文字按钮 + 2 图标按钮全挤一行,
        # 硬撑 435px 最小宽 —— 右栏因此要 507px, 三栏在窄屏放不下、内容被裁
        # (2026-07-11 用户报障)。拆成两行:标题行(标题 + 复制/展示 小图标) +
        ...
        preview_actions.addWidget(self._preview_save_btn)
        ...
        preview_actions.addWidget(self._pin_btn)
