...
1. 下载 GitHub Releases 中的 `SpecimenPhotoWorkbench-v0.58-win64.zip`。
...
- `dist\SpecimenPhotoWorkbench-v0.58-win64.zip`
...
- JPEG XL `cjxl/djxl`：仅在“高压缩 JPEG XL”归档模式下使用；默认“快速 JPG ZIP”不依赖它。
